        ...
        <>
            ...
            <div className='menu'>
                <div className='menu-subhead'>
                    ...
                    <div className='menu-subhead-title'>
                        Sweet Side of Life
                    </div>
                </div>

                <div className='menu-dish' onClick={handleClick}>
                    <div className='menu-dish-title'>
                        <div className='menu-dish-title-text'>
                            Vanilla Super Hero Bowl
                        </div>
                        <img src={Glutenfrei} alt='Dish Title' className='menu-title-img' />
                        <img src={LowCal} alt='Dish Title' className='menu-title-img' />
                        <img src={HighProtein} alt='Dish Title' className='menu-title-img' />
                        <img src={LowCarb} alt='Dish Title' className='menu-title-img' />
